    ...
    <React.Fragment>
      <div className="projects-container">
        ...
        <div className="project-item-container-2">
          ...
          <div className="project-item-description">
            <h1>Mogger</h1>
            <p>A react app for people who play world of warcraft that want to view or post their character appearances. I made this because I wanted to be able to quickly share or find ideas for my characters.</p>
            <div className="project-icons">
              <i className="fab fa-react fa-3x"></i>
              <i class="devicon-postgresql-plain-wordmark fa-3x"></i>
              <i className="fab fa-js-square fa-3x"></i>
            </div>
            <div className="project-links-container">
              <a href="https://github.com/Danex2/mogger" className="project-link" target="_blank" rel="noopener noreferrer">Github</a>
              <a href="https://mogger.herokuapp.com" className="project-link" target="_blank" rel="noopener noreferrer">Live</a>
            </div>
          </div>
        </div>
